...
<div>
    <div class="flex justify-start">
        <div class="float-left text-2xl font-bold">
            ...
            <form action="<?php echo e(route('peng.store')); ?>" method="POST" class="w-full max-w-sm py-2">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        <a href="<?php echo e(route('peng.index')); ?>">
...
<?php echo $__env->make('peng.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\Lara_Breeze\LBreeze_backup\LBreeze\resources\views/peng/create.blade.php ENDPATH**/ ?>